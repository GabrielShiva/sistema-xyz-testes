...
int main (void) {
    ...
    while (true) {
        ...
        start_move_to(&steppers[0], 2200);
        start_move_to(&steppers[1], 2200);
        ...
        start_move_to(&steppers[0], 4000);
        start_move_to(&steppers[1], 400);
        ...
        // start_move_to(&steppers[0], 2000);
        // start_move_to(&steppers[1], 2000);
